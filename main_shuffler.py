...
sys.path.append(args.classifier_path)
test_mode = args.test
...
training_opt['log_dir'] = args.log_dir
training_opt['num_classes'] = args.num_classes
training_opt['classifier_path'] = args.classifier_path
