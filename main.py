...
data_root = {'ImageNet': '/pylon5/pscstaff/rajanie/MLStamps/long-tail/OpenLongTailRecognition-OLTR/OLTRDataset/OLTRDataset_1/campaign3to5_256',
             'Places': '/home/public/dataset/Places365'}

parser = argparse.ArgumentParser()
parser.add_argument('--config', default='/pylon5/pscstaff/rajanie/MLStamps/long-tail/OpenLongTailRecognition-OLTR/config/Imagenet_LT/Stage_1.py', type=str)
