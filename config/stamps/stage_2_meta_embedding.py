...
training_opt['log_dir'] = "/ocean/projects/hum180001p/shared/classification/campaign7/models/stamps"
...
training_opt['sampler'] = {'type': 'ClassAwareSampler', 'def_file': '/ocean/projects/hum180001p/shared/src/ml4docs/mlstamps_oltr/data/ClassAwareSampler.py',
                           'num_samples_cls': 4}
...
feature_param = {'use_modulatedatt': True, 'use_fc': True, 'dropout': None,
                 'stage1_weights': True, 'dataset': training_opt['dataset'], 'weights_path': training_opt['log_dir']}
feature_optim_param = {'lr': 0.01, 'momentum': 0.9, 'weight_decay': 0.0005}
networks['feat_model'] = {'def_file': '/ocean/projects/hum180001p/shared/src/ml4docs/mlstamps_oltr/models/ResNet10Feature.py',
...
networks['classifier'] = {'def_file': '/ocean/projects/hum180001p/shared/src/ml4docs/mlstamps_oltr/models/MetaEmbeddingClassifier.py',
...
criterions = {}
perf_loss_param = {}
criterions['PerformanceLoss'] = {'def_file': '/ocean/projects/hum180001p/shared/src/ml4docs/mlstamps_oltr/loss/SoftmaxLoss.py', 'loss_params': perf_loss_param,
...
criterions['FeatureLoss'] = {'def_file': '/ocean/projects/hum180001p/shared/src/ml4docs/mlstamps_oltr/loss/DiscCentroidsLoss.py', 'loss_params': feat_loss_param,
